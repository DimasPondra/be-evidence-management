    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                @endif
                <form action="{{ route('detail-evidence.update', $item->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <select id="register_id" name="register_id" autocomplete="country"
                                        ...
                                        <option value="{{ $item->register_id }}">{{ $item->register->register_number }}
                                            - Jangan Diubah</option>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <select id="criteria_id" name="criteria_id" autocomplete="country"
                                        class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                        <option value="{{ $item->criteria_id }}">{{ $item->criteria->name }} - Jangan
                                            Diubah</option>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="text" name="name" id="name" autocomplete="given-name"
                                        ...
                                        value="{{ $item->name }}" placeholder="Nama Barang Bukti">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="number" name="amount" id="amount" autocomplete="given-name"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                        value="{{ $item->amount }}" placeholder="Jumlah Barang Bukti">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <div class="mt-1">
                                        <textarea id="description" name="description" rows="3"
                                            ...
                                            placeholder="Masukan detail informasi barang bukti">{{ $item->description }}</textarea>
                                    </div>
                                </div>
