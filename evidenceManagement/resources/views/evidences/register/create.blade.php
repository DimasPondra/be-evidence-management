<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Register Barang Bukti') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                @endif
                <form action="{{ route('register-evidence.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="number" name="register_number" id="register_number"
                                        ...
                                        value="{{ old('register_number') }}" placeholder="Nomer Register">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="text" name="suspect" id="suspect" autocomplete="given-name"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                        value="{{ old('suspect') }}" placeholder="Nama Tersangka">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="text" name="article" id="article" autocomplete="given-name"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                        value="{{ old('article') }}" placeholder="Pasal Kejahatan">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="text" name="prosecutor" id="prosecutor" autocomplete="given-name"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                        value="{{ old('prosecutor') }}" placeholder="Nama Jaksa Penuntut Umum">
                                </div>
